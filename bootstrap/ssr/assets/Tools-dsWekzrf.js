...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<!--]--></div><div class="hidden lg:flex rtl:hidden absolute top-32 inset-e-0 items-start gap-1"><img${ssrRenderAttr("src", "assets/svg/tools.svg")} alt="arrow" class="h-12 w-12 sm:h-16 sm:w-16"><h3 class="text-xl w-[60%] relative top-8 rotate-10">${ssrInterpolate(__props.toolsSectionCaption)}</h3></div><div class="hidden lg:flex ltr:hidden absolute top-32 inset-e-0 items-start gap-1"><img${ssrRenderAttr("src", "assets/svg/tools_arrow_rtl.svg")} alt="arrow" class="h-12 w-12 sm:h-16 sm:w-16"><h3 class="text-xl w-[60%] relative top-2">${ssrInterpolate(__props.toolsSectionCaption)}</h3></div></section>`);
		};
	}
};
...
//# sourceMappingURL=Tools-dsWekzrf.js.map