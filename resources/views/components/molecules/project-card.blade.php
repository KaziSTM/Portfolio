<div
    class="relative rounded-b-xl max-w-6xl px-4 grid grid-cols-1 lg:px-0 xl:grid-cols-2 gap-4 lg:gap-16 bg-slate-100 pt-4 py-0 md:pt-8 lg:pt-14 xl:pt-16">
    ...
    <img loading="lazy" width="1528" height="794" src="{{ asset('assets/svg/home-hero-gradient.svg') }}"
         class="hidden lg:block absolute rotate-180 -left-[30rem] -top-10">
    {{-- Content --}}
