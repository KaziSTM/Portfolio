            ...
            <div
                ...
                <div class="relative grid gap-10 md:gap-14 lg:gap-20 grid-cols-1">
                    @foreach ($features as $feature)
                        <div class="flex items-start space-x-6">
                            <div
                                ...
                                @if (!$loop->last)
                                    <div
                                        class="absolute top-20 w-px border-l-2 border-dotted border-secondary-300 h-full">
                                    </div>
                                @endif
                            </div>
                    ...
                    <div class="hidden lg:block absolute -bottom-32 left-12">
                        <h3 class="text-xl w-[60%] translate-y-16 translate-x-20 -rotate-[10deg]">What differentiates me
                            from
                            others</h3>
                        @svg('feature-arrow')
                    </div>
                ...
                <div class="relative w-full flex justify-center">
                    ...
                    <div class="relative inline-block">
                        ...
                        <img
                            ...
                            alt="decorative star"
                            class="absolute -top-5 -right-6 w-8 md:w-12 lg:w-14 pointer-events-none select-none"
                        />
                    </div>

                    {{-- CV CTA --}}
                    <div
                        class="absolute bottom-4 left-1/2 -translate-x-1/2 md:left-auto md:right-6 md:translate-x-0">
