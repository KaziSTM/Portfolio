...
<template>
    <div>
        <Section class="mt-16">
            <div
                class="container mx-auto space-y-20 text-center lg:text-left"
            >
                <!-- Header -->
                <div
                ...
                >
                    ...
                    <div
                        class="wrap-break-word px-2 text-center md:px-20 lg:px-48 xl:px-96"
                    >
                        <p
                ...
                <!-- Projects -->
                <div
                    class="mt-20 grid justify-center gap-10 px-10 sm:px-16"
                >
                    <ProjectCard
